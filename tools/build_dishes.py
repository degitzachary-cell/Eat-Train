...
BORROWED = [
 dict(name='Har gow, prawn dumpling, steamed (dim sum)', src='F003654', key='R000010',
 ...
 dict(name='Siu mai, pork and prawn dumpling, steamed (dim sum)', src='F003652', key='R000011',
      ...
      note='FSANZ analysed a steamed meat dumpling; this is that food named and portioned '
           'the way it arrives.'),
 dict(name='Gow gee, pan-fried dumpling / potsticker / gyoza (dim sum)', src='F003651', key='R000012',
 ...
 dict(name='Wonton, deep-fried (dim sum)', src='F003651', key='R000013',
 ...
 dict(name='Vegetable dumpling, steamed (dim sum)', src='F003655', key='R000014',
      portions='piece:25;serve of four:100', served=100,
      note='FSANZ analysed a steamed vegetable dumpling, portioned by the piece.'),
 dict(name='Char siu bao, BBQ pork bun, steamed (dim sum)', src='F008837', key='R000015',
      portions='bun:85;serve of three:255', served=100,
      note='FSANZ analysed a savoury steamed pork bun, which is what this is.'),
 dict(name='Salt and pepper squid (dim sum)', src='F008824', key='R000016',
...
MORE = [
 dict(name='Xiao long bao, soup dumpling, steamed (dim sum)', cat='91', key='R000020',
 ...
 dict(name='Cheung fun, prawn rice noodle roll (dim sum)', cat='91', key='R000021',
 ...
 dict(name='Lo mai gai, sticky rice in lotus leaf (dim sum)', cat='91', key='R000022',
 ...
 dict(name='Lo bak go, turnip cake, pan-fried (dim sum)', cat='91', key='R000023',
 ...
 dict(name='Wu gok, taro puff, deep-fried (dim sum)', cat='91', key='R000024',
 ...
 dict(name='Egg tart, dan tat (dim sum)', cat='91', key='R000025',
 ...
 dict(name='Custard bun, lai wong bao, steamed (dim sum)', cat='91', key='R000026',
      ...
      items=[('F004007',30),('F009527',16),('F008976',8),('F003729',8),
             ('F001973',6),('F005634',6)]),
 dict(name='Sesame ball, jian dui, deep-fried (dim sum)', cat='91', key='R000027',
      ...
      items=[('F003998',22),('F009527',10),('F000451',14),('F008976',7),
             ('F008214',4),('F006191',7)]),
 dict(name='Spare ribs in black bean, steamed (dim sum)', cat='91', key='R000028',
      ...
      items=[('F007117',180),('F008065',12),('F004193',5),('F008976',4),
             ('F006191',4),('F003988',3)]),
 dict(name='Beef ball, steamed (dim sum)', cat='91', key='R000029',
      ...
      items=[('F000677',140),('F003988',8),('F006250',10),('F008065',6),
             ('F003192',4),('F006187',2)]),
 dict(name='Mango pancake (dim sum)', cat='91', key='R000030',
 ...
 dict(name='Chicken feet, braised (phoenix claws, dim sum)', cat='91', key='R000031',
